...
const LeftSide = () => {
  return (
    ...
    <div className="w-1/12 flex flex-col items-end pr-4 h-full none-sm">
    <div className="fixed top-0">
    <div className="mt-1 mb-05 transition cursor-pointer hover:bg-gray-200 rounded-full p-3">
    ...
    <div className="mb-05 transition cursor-pointer hover:bg-gray-200 rounded-full p-3">
      <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#111111">
        <g>
    ...
    <div className="mb-05 transition cursor-pointer hover:bg-gray-200 rounded-full p-3 relative">
      <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#111111">
        <g>
      ...
      <small className="block bg-blue-500 text-white py-05 px-1 rounded-full absolute top-0 -rigth-1 text-xs">20+</small>
    </div>
    <div className="mb-05 transition cursor-pointer hover:bg-gray-200 rounded-full p-3">
      <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#111111">
        <g>
    ...
    <div className="mb-1 transition cursor-pointer hover:bg-gray-200 rounded-full p-3">
      <svg viewBox="0 0 24 24" className="w-7 h-7" fill="#111111">
        <g>
    ...
    <div className="mb-05 transition cursor-pointer bg-blue-400 rounded-full p-3 3h2dow-lg">
    ...
    <div className="mt-7 w-14 h-14 rounded-full p-2 cursor-pointer hover:bg-gray-300 flex items-center justify-center">
      <img
        className="w-full h-full rounded-full"
        src="https://i.ibb.co/GWjdjkz/Mr-sagar.jpg"
        alt="MR.sagar"
      />
    </div>
  </div>
